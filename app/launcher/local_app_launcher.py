...
# Custom colormap - black to blue to white
def make_blue_white_palette():
    # Define colors from black to blue to white
    colors = ['blue', 'white']
    
    # Create a custom colormap
    cmap = LinearSegmentedColormap.from_list('blue_white', colors, N=256)
    
    return cmap

# Generate the colormap
BLUE_WHITE_PALETTE = make_blue_white_palette()
'''
...
app_interferogram_dynamics = InteractiveInterferogramDynamics(
    ...
    GammaL0_default=500.0,
    GammaR0_default=100.0,
    Gamma_eg0_default=20.0,
    Gamma_phi0_default=35.0,
    sigma_eps_default=0.000167,
    nu_default=21.0,
    E_C_default=0.281467,
