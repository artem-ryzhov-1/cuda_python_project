////////////////////////////////////////
// app/cuda/src/dissipators/dissipator_dot_lead_sparse_log.cuh
////////////////////////////////////////
...
void dissipator_dot_lead_unrolled_interval_1_log(
    ...
    */
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r00 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r11 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r22 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r33 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r01 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_i01 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r02 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_i02 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r03 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_i03 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r12 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_i12 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r13 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_i13 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_r23 = tmp;
    ...
    d_log_buffer[t_idx_substep].drho_out_D_dl_i23 = tmp;
...
static __device__ __forceinline__
void dissipator_dot_lead_unrolled_interval_2_log(
...
static __device__ __forceinline__
void dissipator_dot_lead_unrolled_interval_3_log(
...
static __device__ __forceinline__
void dissipator_dot_lead_unrolled_interval_4_log(
...
static __device__ __forceinline__
void dissipator_dot_lead_unrolled_interval_5_log(
...
static __device__ __forceinline__
void dissipator_dot_lead_unrolled_interval_6_log(
...
void dissipator_dot_lead_unrolled_sparse_log(
    ...
    if (eps_t_substep < -epsilon_L_loc) {
        dissipator_dot_lead_unrolled_interval_1_log(
    ...
    // Interval 2
        ...
        dissipator_dot_lead_unrolled_interval_2_log(
    ...
    // Interval 3
        ...
        dissipator_dot_lead_unrolled_interval_3_log(
    ...
    // Interval 4
        ...
        dissipator_dot_lead_unrolled_interval_4_log(
    ...
    // Interval 5
        ...
        dissipator_dot_lead_unrolled_interval_5_log(
    ...
    // Interval 6
        ...
        dissipator_dot_lead_unrolled_interval_6_log(
    ...
    d_log_buffer[t_idx_substep].interval_dissipator = interval;
    d_log_buffer[t_idx_substep].gp_sqr = gp_sqr;
    d_log_buffer[t_idx_substep].gm_sqr = gm_sqr;
    d_log_buffer[t_idx_substep].gp_gm  = gp_gm;
    d_log_buffer[t_idx_substep].Gamma_lprm = Gamma_lprm;
    d_log_buffer[t_idx_substep].Gamma_lmrp = Gamma_lmrp;
}
