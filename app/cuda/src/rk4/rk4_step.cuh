...
// FSAL (First Same As Last) optimized RK4
// Saves k4 from previous step to use as k1 in next step
// Reduces compute_drho calls from 4 to 3 per step (25% speedup!)

__device__ __forceinline__
void rk4_step_unrolled_v3_safe_fsal(
    float& rho_vec_0, float& rho_vec_1, float& rho_vec_2, float& rho_vec_3,
    float& rho_vec_4, float& rho_vec_5, float& rho_vec_6, float& rho_vec_7,
    float& rho_vec_8, float& rho_vec_9, float& rho_vec_10, float& rho_vec_11,
    float& rho_vec_12, float& rho_vec_13, float& rho_vec_14, float& rho_vec_15,
...
//     float k_saved[16]; // persistent between steps
//     
//     // First step
//     rk4_step_unrolled_fsal(rho..., k_saved..., t, eps0, A, true);
//     
//     // Subsequent steps
//     for (int i = 1; i < num_steps; i++) {
//         rk4_step_unrolled_fsal(rho..., k_saved..., t, eps0, A, false);
//         t += dt;
//     }
// }
...
__device__ __forceinline__
void rk4_step_unrolled_v3_safe_ensemble(
    float& rho_vec_0, float& rho_vec_1, float& rho_vec_2, float& rho_vec_3,
    float& rho_vec_4, float& rho_vec_5, float& rho_vec_6, float& rho_vec_7,
    float& rho_vec_8, float& rho_vec_9, float& rho_vec_10, float& rho_vec_11,
    float& rho_vec_12, float& rho_vec_13, float& rho_vec_14, float& rho_vec_15,
    ...
    compute_drho_unrolled_ensemble(
        rho_vec_0, rho_vec_1, rho_vec_2, rho_vec_3,
        rho_vec_4, rho_vec_5, rho_vec_6, rho_vec_7,
        rho_vec_8, rho_vec_9, rho_vec_10, rho_vec_11,
        rho_vec_12, rho_vec_13, rho_vec_14, rho_vec_15,
...
__device__ __forceinline__
void rk4_step_unrolled_v3_safe_ensemble_fsal(
    float& rho_vec_0, float& rho_vec_1, float& rho_vec_2, float& rho_vec_3,
    float& rho_vec_4, float& rho_vec_5, float& rho_vec_6, float& rho_vec_7,
    float& rho_vec_8, float& rho_vec_9, float& rho_vec_10, float& rho_vec_11,
    float& rho_vec_12, float& rho_vec_13, float& rho_vec_14, float& rho_vec_15,
